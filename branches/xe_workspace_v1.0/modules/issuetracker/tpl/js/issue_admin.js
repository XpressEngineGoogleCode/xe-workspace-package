...
function completeInsertSetting(ret_obj) {
    ...
    var message = ret_obj['message'];
    var module_srl = ret_obj['module_srl'];
    var return_act = ret_obj['return_act'] || 'dispIssuetrackerAdminProjectSetting';
    var url = current_url.setQuery('act',return_act);
    if(module_srl) url = url.setQuery('module_srl',module_srl);
    location.href = url;
}
...
function completeReleaseInsertSetting(ret_obj) {
    var error = ret_obj['error'];
    var message = ret_obj['message'];
    if(ret_obj['success_return_url'])
    {
        var url = ret_obj['success_return_url'];
    }
    else
    {

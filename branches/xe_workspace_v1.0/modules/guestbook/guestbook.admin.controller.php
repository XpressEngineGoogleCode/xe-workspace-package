<?php
    ...
    class guestbookAdminController extends guestbook {
        ...
        function procInsertGestBook($args)
        {
            ...
            if(!$args->module_srl) {
                return $oModuleController->insertModule($args);
            } else {
                return $oModuleController->updateModule($args);
            }
        }
        ...
        function procGuestbookAdminInsertGuestbook($args = null) {
            ...
            // insert/update guestbook module, depending on whether module_srl exists or not
            $output = $this->procInsertGestBook($args);
            if(!$args->module_srl) {
        	...
        	if(!in_array(Context::getRequestMethod(),array('XMLRPC','JSON')) || !$args) {

<?php
    ...
    class guestbookModel extends module {
        ...
        function getVoteByGSrls($srls, $mSrl = NULL)
        {
            $args->guestbook_item_srl = $srls;
            if($mSrl)$args->member_srl = $mSrl;
            $output = executeQueryArray('guestbook.getVote',$args);
            return $output;
        }
		...
		function getTagList($obj){
            ...
            $output = executeQueryArray('guestbook.getTagList', $obj);
